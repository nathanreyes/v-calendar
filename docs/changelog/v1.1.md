...
Reference the guides below to help update your `v-calendar` and `v-date-picker` components to `v1.1.0`.
...
8. [Remove `input-props` prop](#_8-remove-input-props-prop)
...
* Fixes initial render when `document` not available
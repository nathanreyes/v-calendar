      ...
      ? h('div', [
          ...
          h(
            Popover,
            {
              ...
              onBeforeShow: e => this.$emit('popover-will-show', e),
              onAfterShow: e => this.$emit('popover-did-show', e),
              onBeforeHide: e => this.$emit('popover-will-hide', e),
              onAfterHide: e => this.$emit('popover-did-hide', e),
              ref: 'popover',
            },
            {
              default: content,

<template>
<div class='c-day'>
  <!-- Configured background layer -->
  <div class='c-day-layer c-day-wrap-center' v-if='showBackground'>
    <div :class='backgroundClass' :style='backgroundStyle'></div>
  </div>
...
export default {
  ...
  computed: {
    computedData() {
      ...
      if (this.configureData) this.configureData(data);
      return data;
    },
    computedTheme() {
      const cd = this.computedData;
      const t = this.theme;
      const color = t.dayColor;
      ...
      const theme = {
        ...
        contentStyle: {
          ...this.getBoxStyle(),
          ...this.getCircleStyle(t.dayHoverHeight),
          color: cd.isToday ? t.todayColor : t.dayColor,
    ...
    label() {
      return this.computedData.label;
    },
    day() {
      return this.computedData.day;
    },
    weekday() {
      return this.computedData.weekday;
    },
    week() {
      return this.computedData.label;
    },
    month() {
      return this.computedData.month;
    },
    year() {
      return this.computedData.year;
    },
    isToday() {
      return this.computedData.isToday;
    },
    inMonth() {
      return this.computedData.inMonth;
    },
    beforeMonth() {
      return this.computedData.beforeMonth;
    },
    afterMonth() {
      return this.computedData.afterMonth;
    },
    selectMode() {
      return this.computedData.selectMode;
    },
    dragActive() {
      return this.computedData.dragActive;
    },
    startsDrag() {
      return this.computedData.startsDrag;
    },
    endsDrag() {
      return this.computedData.endsDrag;
    },
    isDragged() {
      return this.computedData.isDragged;
    },
    startsSelection() {
      return this.computedData.startsSelection;
    },
    endsSelection() {
      return this.computedData.endsSelection;
    },
    isSelected() {
      return this.computedData.isSelected;
    },
    showBackground() {
      return ((this.computedTheme.backgroundClass || this.computedTheme.backgroundStyle) && !this.isDragged);
    },
    backgroundClass() {
      return this.computedTheme.backgroundClass;
    },
    backgroundStyle() {
      return this.computedTheme.backgroundStyle;
    },
    showSingleSelectBackground() {
      return this.selectMode !== 'range' && this.isSelected && !this.dragActive;
    },
    singleSelectBackgroundClass() {
      return this.computedTheme.singleSingleBackgroundClass;
    },
    singleSelectBackgroundStyle() {
      return this.computedTheme.singleSelectBackgroundStyle;
    },
    contentClass() {
      return this.computedTheme.contentClass;
    },
    contentStyle() {
      return this.computedTheme.contentStyle;
    },
  },
  methods: {
